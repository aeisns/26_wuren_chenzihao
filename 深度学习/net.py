...
class mixed_net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 16, kernel_size=3, padding=1)  # 输入(3,64,64)→输出(16,64,64)
        self.bn1 = nn.BatchNorm2d(16)
        self.pool1 = nn.MaxPool2d(2, 2)  # →(16,32,32)

        self.conv2 = nn.Conv2d(16, 32, kernel_size=3, padding=1)  # →(32,32,32)
        self.bn2 = nn.BatchNorm2d(32)
        self.pool2 = nn.MaxPool2d(2, 2)  # →(32,16,16)

        self.conv3 = nn.Conv2d(32, 64, kernel_size=3, padding=1)  # →(64,16,16)
        self.bn3 = nn.BatchNorm2d(64)
        self.pool3 = nn.MaxPool2d(2, 2)  # →(64,8,8)

        self.fc1 = nn.Linear(64 * 8 * 8, 128)
        self.fc2 = nn.Linear(128, 3)  # 输出3类（blue/red/yellow）
